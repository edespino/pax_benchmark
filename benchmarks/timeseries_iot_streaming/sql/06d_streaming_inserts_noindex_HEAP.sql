--
-- Phase 6d: Streaming INSERTs - Phase 1 (NO INDEXES) - WITH HEAP
...
-- ⚠️  Expected: HEAP fastest Phase 1 writes, but will show bloat in Phase 2
--

\timing on

\echo '===================================================='
\echo 'Streaming Benchmark - Phase 6d: Streaming INSERTs (NO INDEXES) - WITH HEAP'
\echo '===================================================='
\echo ''
...
\echo '⚠️  Expected: HEAP fastest initially, but will show bloat with indexes'
\echo ''
\echo 'This will take approximately 18-25 minutes (5 variants)...'
\echo ''
...
\echo ''
\echo 'Streaming INSERT simulation complete (including HEAP)!'
\echo ''
