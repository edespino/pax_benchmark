...
\echo '  ✅ call_id (~1,000,000 unique)'
\echo '  ✅ caller_number (~1,000,000 unique)'
\echo '  ✅ callee_number (~1,000,000 unique)'
...
\echo '  bloomfilter_columns=''call_id,caller_number,callee_number'''
...
\echo ''
\echo 'NOTE: This benchmark limits to 3 bloom columns per Oct 2025 lessons.'
\echo '      cell_tower_id safe but excluded to prevent overhead.'
\echo ''
