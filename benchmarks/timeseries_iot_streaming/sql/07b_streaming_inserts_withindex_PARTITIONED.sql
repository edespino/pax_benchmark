--
-- Phase 7b: Streaming INSERTs - Phase 2 (WITH INDEXES) - PARTITIONED
...
--   3. METRICS TABLE: streaming_metrics_phase2_partitioned
--
...
--
-- Core Innovation: Tests INSERT throughput with index maintenance overhead
...
\echo '===================================================='
\echo 'Streaming Benchmark - Phase 7b: Streaming INSERTs (WITH INDEXES) - PARTITIONED'
\echo '===================================================='
\echo ''
...
DROP TABLE IF EXISTS cdr.streaming_metrics_phase2_partitioned CASCADE;

CREATE TABLE cdr.streaming_metrics_phase2_partitioned (
...
BEGIN
    ...
    FOR v_batch_num IN 1..500 LOOP
        ...
        INSERT INTO cdr.streaming_metrics_phase2_partitioned VALUES (
